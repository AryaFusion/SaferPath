...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-56 bg-[#F7F7F5] border-r border-[#D9DDE3] flex flex-col justify-between p-3.5 min-h-screen shrink-0 hidden md:flex">
      {/* Top Brand & Header */}
      <div className="space-y-5">
        ...
        >
          ...
          <div className="flex flex-col justify-center">
            <span className="text-sm font-bold text-[#142033] tracking-tight block leading-tight">
              SaferPath
            </span>
            <span className="text-[11px] text-[#5F6B7A] font-medium block leading-none mt-0.5">
              Mobility context
            </span>
          </div>
        </button>
        ...
        <nav className="space-y-0.5" aria-label="Sidebar Navigation">
              ...
              <button
                ...
                className={`w-full flex items-center gap-2.5 px-2.5 py-2 rounded-md text-xs font-medium transition-colors cursor-pointer text-left focus-visible-ring ${
                  isActive
                    ...
                    : 'text-[#5F6B7A] hover:text-[#142033] hover:bg-[#F1F3F2]'
                }`}
              >
                <span className={`shrink-0 flex items-center justify-center ${isActive ? 'text-[#0B8F83]' : 'text-[#5F6B7A]'}`}>
                  {item.icon}
                </span>
          ...
          <div className="my-2.5 border-t border-[#D9DDE3]" />
      ...
      {/* Footer Info Box */}
      <div className="border-t border-[#D9DDE3] pt-3 text-[11px] text-[#5F6B7A] space-y-0.5">
        <div className="font-semibold text-[#142033]">SaferPath v1.0</div>
