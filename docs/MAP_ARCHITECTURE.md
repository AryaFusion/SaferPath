...
- **Component**: [`MapLibreRouteMap.tsx`](file:///c:/users/Administrator/Desktop/SAFER%20PATH%20-%20Codex/saferpath/src/components/map/MapLibreRouteMap.tsx)
...
- **Client Module**: [`valhallaClient.ts`](file:///c:/users/Administrator/Desktop/SAFER%20PATH%20-%20Codex/saferpath/src/api/routing/valhallaClient.ts)
